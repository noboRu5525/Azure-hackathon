    ...
    try:
        response = client.chat.completions.create(
            ...
            messages=[
                ...
                {"role": "user", "content": "・制作したいもの：食材管理アプリケーション\n・具体的な機能: カメラで撮影した画像をもとに冷蔵庫の中にある食材を検出して管理、データベースに搭載されている食材からレシピを生成、相性の良い食材を考えて、買うべき食材を提案する\n・制作日数：80日（1週間を7日とする）\n・使用する言語：Python、HTML、CSS、JavaScript \n・使用ツール：Firebases \n・使用したことのある言語：Python・使用したことのある言語：Python、HTML、CSS \n I am working on a personal development project and need help in creating a task plan to efficiently achieve my goals. Please create a learning plan to reach my goals efficiently, including daily activities. In the plan, detail the specific programming languages and tools (such as APIs) to be used. Exclude learning for languages I have already used. As this is a personal project, please create a relaxed schedule, making full use of the designated development days."}
            ]
        )
