    ...
    try:
        response = client.chat.completions.create(
            ...
            messages=[
                ...
                {"role": "user", "content": "TOEICのスコアを向上させるための学習計画を作成し、具体的な学習教材名も提案してください。また計画は、全体的な戦略と週単位の活動、および推奨される学習教材に焦点を当ててください。また、教材は日本人に適するものを考案してください。教材はオンラインストアなどのレビューやランキングをもとに考えてください。以下の情報に基づいてください：・現在のTOEICスコア：600・目標のTOEICスコア：750・期限：90日後"},
            ]
        )
